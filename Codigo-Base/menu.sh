...
gren=$(tput setaf 2)
yellow=$(tput setaf 3)
SCPdir="/etc/SCRIPT-ELEMENT" && [[ ! -d ${SCPdir} ]] && exit 1
SCTemp="/etc/SCRIPT-ELEMENT/temp" && [[ ! -d ${SCTemp} ]] && exit 1
...
msg() {
  ...
  [[ ! -e /etc/SCRIPT-ELEMENT/temp/version_instalacion ]] && echo 1 >/etc/SCRIPT-ELEMENT/temp/version_instalacion
  v11=$(cat /etc/SCRIPT-ELEMENT/temp/version_actual)
  ...
  local colors="/etc/SCRIPT-ELEMENT/colors"
  if [[ ! -e $colors ]]; then
  ...
  -tit) echo -e " \e[48;5;214m\e[38;5;0m      🖥  SCRIPT | ELEMENT  🖥      \e[0m  $vesaoSCT" ;;
  esac
}
...
#--- FUNCION IP ACTUAL
fun_ip() {
  if [[ -e /etc/SCRIPT-ELEMENT/MEUIPvps ]]; then
    IP="$(cat /etc/SCRIPT-ELEMENT/MEUIPvps)"
  else
    MEU_IP=$(wget -qO- ifconfig.me)
    echo "$MEU_IP" >/etc/SCRIPT-ELEMENT/MEUIPvps
  fi
}
...
[[ $(find /etc/SCRIPT-ELEMENT/temp/ | grep -w "sshtotal" | head -1) ]] || SSH4="0"
[[ $(find /etc/SCRIPT-ELEMENT/temp/ | grep -w "sshtotal" | head -1) ]] && SSH4=$(cat /etc/SCRIPT-ELEMENT/temp/sshtotal)
...
[[ $(find /etc/SCRIPT-ELEMENT/ | grep -w "RegV2ray" | head -1) ]] || v2ray="0"
[[ $(find /etc/SCRIPT-ELEMENT/ | grep -w "RegV2ray" | head -1) ]] && v2ray="$(cat /etc/SCRIPT-ELEMENT/RegV2ray | wc -l)"
on="\033[93m[\033[1;32m ON \033[93m]" && off="\033[93m[ \033[1;31mOFF \033[93m]"
[[ $(ps x | grep badvpn | grep -v grep | awk '{print $1}') ]] && badvpn=$on || badvpn=$off
VERY="$(ps aux | grep "/etc/SCRIPT-ELEMENT/menu.sh verificar" | grep -v grep)"
VERY2="$(ps aux | grep "/etc/SCRIPT-ELEMENT/menu.sh desbloqueo" | grep -v grep)"
VERY3="$(ps aux | grep "${SCPdir}/menu.sh monitorservi" | grep -v grep)"
VERY4="$(ps aux | grep "${SCPdir}/menu.sh autolim" | grep -v grep)"
[[ -e "/etc/SCRIPT-ELEMENT/temp/T-Lim" ]] && limseg="$(less /etc/SCRIPT-ELEMENT/temp/T-Lim)"
...
#ONLINES
[[ -e /etc/SCRIPT-ELEMENT/temp/USRonlines ]] && {
  msg -bar
  onssh=$(cat /etc/SCRIPT-ELEMENT/temp/USRonlines)
  echo -ne "\033[1;32m CONECTADOS:\033[1;36m[\e[97m $onssh \033[1;36m]"
}
#EXPIRADOS
[[ -e /etc/SCRIPT-ELEMENT/temp/USRexpired ]] && {
  expi=$(cat /etc/SCRIPT-ELEMENT/temp/USRexpired)
  echo -ne "\e[1;31m EXPIRADOS:\033[1;36m[\e[1;97m $expi \033[1;36m]"
}
#BLOQUEADOS
[[ -e /etc/SCRIPT-ELEMENT/temp/USRbloqueados ]] && {
  bloc=$(cat /etc/SCRIPT-ELEMENT/temp/USRbloqueados)
...
canbio_color() {
  ...
  msg -bar2
  msg -tit
  msg -ama "     CONTROLADOR DE COLORES DEL SCRIPT ELEMENT"
  msg -bar2
  ...
  echo "$cores" >/etc/SCRIPT-ELEMENT/colors
  msg -bar2
}
...
fun_autorun() {
  if [[ -e /etc/bash.bashrc-bakup ]]; then
    ...
    cat /etc/bash.bashrc | grep -v "/etc/SCRIPT-ELEMENT/menu.sh" >/tmp/bash
    ...
    echo '/etc/SCRIPT-ELEMENT/menu.sh' >>/etc/bash.bashrc.2
...
speed_test() {
  ...
  wget -O /opt/speed/speedtest https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/Ejecutables/speedtest.py &>/dev/null
...
ajuste_in() {
  ...
  pamcrack() { #DESACTIVAR PASS ALFANUMERICO
    ...
    [[ $x = @(n|N) ]] && msg -bar && return
    echo -e ""
    wget -O /etc/pam.d/common-password https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/Ejecutables/common-password &>/dev/null
...
fai2ban_fun() {
  ...
  remove_fail2ba() {
    ...
    rm -rf /etc/SCRIPT-ELEMENT/fail2ban &>/dev/null
...
noti_bot() {
  add_id() {
    ...
    echo "$idtele" >/etc/SCRIPT-ELEMENT/temp/idtelegram
    echo "-100$idgrupo" >/etc/SCRIPT-ELEMENT/temp/idgrupo
    echo "$nomvps" >/etc/SCRIPT-ELEMENT/temp/vpstelegram
    msg -bar
  }
  del_noti() {
    echo -e "\033[1;37mREGISTRO DE NOTIBOT BORRADO \e[1;32m"
    echo "00000000" >/etc/SCRIPT-ELEMENT/temp/idtelegram
    echo "00000000" >/etc/SCRIPT-ELEMENT/temp/vpstelegram
    echo "00000000" >/etc/SCRIPT-ELEMENT/temp/idgrupo
    msg -bar
  }
  msg_test() {
...
token_ge() {
  ...
  echo "$passgeneral" >/etc/SCRIPT-ELEMENT/temp/.passw
  msg -bar
  read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
  herramientas_fun
}
...
recuperar_base() {
  ...
  msg -bar2
  rm -rf /etc/SCRIPT-ELEMENT/backuplog/principal >/dev/null 2>&1
  i="1"
  [[ -z $(ls /etc/SCRIPT-ELEMENT/backuplog) ]] && echo -e "" || {
    for my_arqs in $(ls /etc/SCRIPT-ELEMENT/backuplog); do
      [[ -d "$my_arqs" ]] && continue
      select_arc[$i]="$my_arqs"
    ...
    file="$backselect"
    tar -xzvf ./$file
    cat /etc/SCRIPT-ELEMENT/backuplog/principal/cuentassh >/etc/SCRIPT-ELEMENT/cuentassh
    cat /etc/SCRIPT-ELEMENT/backuplog/principal/cuentahwid >/etc/SCRIPT-ELEMENT/cuentahwid
    cat /etc/SCRIPT-ELEMENT/backuplog/principal/cuentatoken >/etc/SCRIPT-ELEMENT/cuentatoken
    cd
    msg -bar
    echo -e "\e[1;32m  >> Completado con Exito!"
  }
...
chekc_users() {
  ...
  fun_initcheck() {
    ...
    if [[ "$resposta" = '1' ]]; then
      if ps x | grep -w checkuser | grep -v grep 1>/dev/null 2>/dev/null; then
        ...
        verif_ptrs $porta
        fun_check() {
          screen -dmS checkuser python3 /etc/SCRIPT-ELEMENT/filespy/check.py $porta 1
          [[ $(grep -wc "check.py" /etc/autostart) = '0' ]] && {
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/SCRIPT-ELEMENT/filespy/check.py $porta 1; }" >>/etc/autostart
          } || {
            sed -i '/check.py/d' /etc/autostart
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/SCRIPT-ELEMENT/filespy/check.py $porta 1; }" >>/etc/autostart
          }
        ...
        fun_check2() {
          screen -dmS checkuser python3 /etc/SCRIPT-ELEMENT/filespy/4gcheck.py $porta 2
          [[ $(grep -wc "4gcheck.py" /etc/autostart) = '0' ]] && {
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/SCRIPT-ELEMENT/filespy/check.py $porta 2; }" >>/etc/autostart
          } || {
      ...
      if ps x | grep -w 4gcheck | grep -v grep 1>/dev/null 2>/dev/null; then
        ...
        verif_ptrs $porta
        fun_udpon() {
          screen -dmS 4gcheck python3 /etc/SCRIPT-ELEMENT/filespy/4gcheck.py $porta
          [[ $(grep -wc "4gcheck.py" /etc/autostart) = '0' ]] && {
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/SCRIPT-ELEMENT/filespy/4gcheck.py $porta; }" >>/etc/autostart
          } || {
            sed -i '/check.py/d' /etc/autostart
            echo -e "netstat -tlpn | grep -w $porta > /dev/null || {  screen -r -S 'ws' -X quit;  screen -dmS checkuser python3 /etc/SCRIPT-ELEMENT/filespy/4gcheck.py $porta; }" >>/etc/autostart
          }
  ...
  inst_depedencias() {
    ...
    # download check.py
    [[ -e "/etc/SCRIPT-ELEMENT/filespy/check.py" ]] && {
      sleep 0.1
    } || {
      cd $HOME
      wget https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/Ejecutables/check.py -o /dev/null
      mv -f $HOME/check.py /etc/SCRIPT-ELEMENT/filespy/check.py
    }

    [[ -e "/etc/SCRIPT-ELEMENT/filespy/4gcheck.py" ]] && {
      sleep 0.1
    } || {
      cd $HOME
      wget https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/Ejecutables/4gcheck.py -o /dev/null
      mv -f $HOME/4gcheck.py /etc/SCRIPT-ELEMENT/filespy/4gcheck.py
    }
    ...
    [[ -e "/bin/check" ]] && {
      ...
      cd $HOME
      wget https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/Ejecutables/check -o /dev/null
      mv -f $HOME/check /bin/check
      chmod 777 /bin/check
    }
  }

  [[ -e "/etc/SCRIPT-ELEMENT/filespy/check.py" ]] && [[ -e "/etc/SCRIPT-ELEMENT/filespy/4gcheck.py" ]] && [[ -e "/bin/check" ]] && {
    fun_initcheck
  } || {
...
monservi_fun() {
  ...
  #MONITOREAR
  monssh() {
    echo "resetssh" >/etc/SCRIPT-ELEMENT/temp/monitorpt
  }
  mondropbear() {
    echo "resetdropbear" >>/etc/SCRIPT-ELEMENT/temp/monitorpt
  }
  monssl() {
    echo "resetssl" >>/etc/SCRIPT-ELEMENT/temp/monitorpt
  }
  monsquid() {
    echo "resetsquid" >>/etc/SCRIPT-ELEMENT/temp/monitorpt
  }
  monapache() {
    echo "resetapache" >>/etc/SCRIPT-ELEMENT/temp/monitorpt
  }
  monv2ray() {
    echo "resetv2ray" >>/etc/SCRIPT-ELEMENT/temp/monitorpt
  }
  monwebsoket() {
    echo "resetwebp" >>/etc/SCRIPT-ELEMENT/temp/monitorpt
  }
  msg -bar
  msg -tit
  msg -bar
  ...
  if [[ -z $PIDVRF3 ]]; then
    ...
    echo "null" >/etc/SCRIPT-ELEMENT/temp/monitorpt
    ...
    error() {
      ...
      tput dl1
      tiemmoni="120"
      echo "${tiemmoni}" >/etc/SCRIPT-ELEMENT/temp/T-Mon
...
monitor_auto() {
  for servicex in $(cat /etc/SCRIPT-ELEMENT/temp/monitorpt); do
    rebootnb $servicex
  done
}
...
autolimpieza_fun() {
  ...
  if [[ -z $PIDVRF4 ]]; then
    ...
    echo ""
    screen -dmS autolimpieza watch -n 43200 /etc/SCRIPT-ELEMENT/menu.sh "autolim"
  else
...
creditoss() {
  ...
  msg -bar
  echo -ne "\033[1;97m            \e[100m CAMBIOS DE SCRIPT ELEMENT \e[0;97m \n"
  registro=$(curl -sSL "https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/cambios")
  echo -ne "$registro"
  msg -bar
...
proto_dropbear() {
  activar_dropbear() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m         INSTALADOR DROPBEAR | SCRIPT ELEMENT"
    msg -bar
...
proto_ssl() {
  ...
  ssl_stunel() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m             INSTALADOR SSL SCRIPT ELEMENT"
    msg -bar
    ...
    msg -bar
    rm -rf /etc/SCRIPT-ELEMENT/stunnel.crt >/dev/null 2>&1
    rm -rf /etc/SCRIPT-ELEMENT/stunnel.key >/dev/null 2>&1
  ...
  msg -tit
  msg -bar
  echo -e "\e[1;93m    INSTALADOR MONO Y MULTI SSL | SCRIPT ELEMENT"
  msg -bar
...
proto_squid() {
  ...
  fun_squid() {
    ...
    msg -tit
    msg -bar
    msg -ama "         INSTALADOR SQUID | SCRIPT ELEMENT "
    msg -bar
    fun_ip
...
#portas" >$var_squid
      ...
      echo -e "
#nome
visible_hostname SCRIPT-ELEMENT
...
proto_badvpn() {
  activar_badvpn() {
    ...
    echo "$portasx" >/etc/SCRIPT-ELEMENT/PortM/Badvpn.log
    msg -bar
    totalporta=($portasx)
    unset PORT
    for ((i = 0; i < ${#totalporta[@]}; i++)); do
  ...
  desactivar_badvpn() {
    ...
    rm -rf /etc/SCRIPT-ELEMENT/PortM/Badvpn.log >/dev/null 2>&1
  ...
  if [[ ! -e /bin/badvpn-udpgw ]]; then
    wget -O /bin/badvpn-udpgw https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/Ejecutables/badvpn-udpgw &>/dev/null
...
proto_shadowsockN() {
  ...
  fun_shadowsocks() {
    ...
    while true; do
      ...
      msg -tit
      msg -bar
      msg -ama "      INSTALADOR SHADOWSOCKS | SCRIPT ELEMENT"
      msg -bar
...
EOF
  ...
  fun_shadowsocks() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m INSTALADOR SHADOWSOCK-LIBEV+(obfs) | SCRIPT ELEMENT"
    msg -bar
    instaladossb_fun
...
proto_websockete() {
  ...
  activar_websokete() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m  INSTALADOR DE WEBSOCKET EDITABLE | SCRIPT ELEMENT \033[1;37m"
    msg -bar
    porta_socket=
    ...
    msg -bar
    echo -ne "\033[1;97m Introduzca el texto de estado plano o en HTML:\n \033[1;31m" && read -p " " -e -i "By SCRIPT | ELEMENT" texto_soket
    msg -bar
    echo -ne "\033[1;97m Digite algun puerto de anclaje\n Puede ser un SSH/DROPBEAR/SSL/OPENVPN:\033[1;92m" && read -p " " -e -i "22" puetoantla
    msg -bar
    echo -ne "\033[1;97m Estatus de encabezado (200,101,404,500,etc):\033[1;92m" && read -p " " -e -i "101" rescabeza
    msg -bar
    (
      less <<PYTHON >/etc/SCRIPT-ELEMENT/filespy/PDirect-$porta_socket.py
...
PYTHON
    ...
    chmod +x /etc/SCRIPT-ELEMENT/filespy/PDirect.py
    screen -dmS pydic-"$porta_socket" python /etc/SCRIPT-ELEMENT/filespy/PDirect-$porta_socket.py && echo "$porta_socket" >>/etc/SCRIPT-ELEMENT/PortM/PDirect.log
  ...
  desactivar_websokete() {
    ...
    rm -rf /etc/SCRIPT-ELEMENT/filespy/PDirect-$portselect.py >/dev/null 2>&1
    sed -i '/'$portselect'/d' /etc/SCRIPT-ELEMENT/PortM/PDirect.log >/dev/null 2>&1
    msg -bar
...
proto_popenvpn() {
  activar_openvpn() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE PROXY OPENVPN | SCRIPT ELEMENT \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
      echo -ne "\033[1;97m Digite el Puerto para el Websoket:\033[1;92m" && read -p " " -e -i "80" porta_socket
    done
    msg -bar
    echo -ne "\033[1;97m Introduzca el texto de estado plano o en HTML:\n \033[1;31m" && read -p " " -e -i "By SCRIPT | ELEMENT" texto_soket
    msg -bar
    screen -dmS popenvpn-"$porta_socket" python /etc/SCRIPT-ELEMENT/filespy/POpen.py "$porta_socket" "$texto_soket" && echo ""$porta_socket"" >>/etc/SCRIPT-ELEMENT/PortM/POpen.log
  ...
  desactivar_popen() {
    ...
    rm -rf /etc/SCRIPT-ELEMENT/PortM/POpen.log >/dev/null 2>&1
...
proto_ppublico() {
  ...
  activar_ppublico() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE PROXY PUBLICO | SCRIPT ELEMENT \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
    ...
    echo -ne "\033[1;97m Introduzca el texto de estado plano o en HTML:\n \033[1;31m" && read -p " " -e -i "By SCRIPT | ELEMENT" texto_soket
    msg -bar
    screen -dmS ppublico-"$porta_socket" python /etc/SCRIPT-ELEMENT/filespy/PPub.py "$porta_socket" "$texto_soket" && echo ""$porta_socket"" >>/etc/SCRIPT-ELEMENT/PortM/PPub.log
  ...
  desactivar_ppublico() {
    ...
    msg -bar
    echo -e "\033[1;97m Procesando ...."
    rm -rf /etc/SCRIPT-ELEMENT/PortM/PPub.log >/dev/null 2>&1
...
proto_pprivado() {
  activar_pprivado() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE PROXY PRIVADO | SCRIPT ELEMENT \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
    ...
    echo -ne "\033[1;97m Introduzca el texto de estado plano o en HTML:\n \033[1;31m" && read -p " " -e -i "By SCRIPT | ELEMENT" texto_soket
    msg -bar
    screen -dmS pprivado-"$porta_socket" python3 /etc/SCRIPT-ELEMENT/filespy/PPriv.py "$porta_socket" "$texto_soket" "$IP" && echo ""$porta_socket"" >>/etc/SCRIPT-ELEMENT/PortM/PPriv.log
  ...
  desactivar_pprivado() {
    ...
    msg -bar
    echo -e "\033[1;97m Procesando ...."
    rm -rf /etc/SCRIPT-ELEMENT/PortM/PPriv.log >/dev/null 2>&1
...
proto_pgettunel() {
  activar_gettunel() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE GETTUNEL | SCRIPT ELEMENT \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
    ...
    msg -bar
    echo -ne "\033[1;97m Digite una contraseña:\n \033[1;31m" && read -p " " -e -i "SCRIP-ELEMENT" passg
    echo "$passg" >/etc/SCRIPT-ELEMENT/filespy/pwd.pwd
    msg -bar
    while read service; do
      [[ -z $service ]] && break
      echo "127.0.0.1:$(echo $service | cut -d' ' -f2)=$(echo $service | cut -d' ' -f1)"
    done <<<"$(mportas)"
    screen -dmS getpy python /etc/SCRIPT-ELEMENT/filespy/PGet.py -b "0.0.0.0:porta_socket" -p "/etc/SCRIPT-ELEMENT/filespy/pwd.pwd"
...
proto_ptcpover() {
  activar_tcpover() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;33m     INSTALADOR DE TCPOVER | SCRIPT ELEMENT \033[1;37m"
    msg -bar
    porta_socket=
    while [[ -z $porta_socket || ! -z $(mportas | grep -w $porta_socket) ]]; do
    ...
    msg -bar
    echo -ne "\033[1;97m Digite una banner txt:\n \033[1;31m" && read -p " " -e -i "SCRIPT-ELEMENT" passg
    msg -bar
    while read service; do
      [[ -z $service ]] && break
      echo "127.0.0.1:$(echo $service | cut -d' ' -f2)=$(echo $service | cut -d' ' -f1)"
    ...
    cd socks
    patch="https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/Ejecutables/backsocz.zip"
    arq="backsocz.zip"
...
#--- SLOWN DNS
proto_slowndns() {
  mkdir -p /etc/SCRIPT-ELEMENT/temp/SlowDNS/install >/dev/null 2>&1
  mkdir -p /etc/SCRIPT-ELEMENT/temp/SlowDNS/Key >/dev/null 2>&1
  SlowDNSinstall="/etc/SCRIPT-ELEMENT/temp/SlowDNS/install"
  SlowDNSconf="/etc/SCRIPT-ELEMENT/temp/SlowDNS/Key"
  info() {
  ...
  NOREPEAT+="$Port\n"            
  case ${reQ} in
  sshd|dropbear|stunnel4|stunnel|v2ray|xray|python|python3)DPB+=" $reQ:$Port";;              
  *)continue;;          
  esac      
  done <<< "${portasVAR}"   
  }
  ...
  ini_slow() {
    ...
    msg -bra "              INSTALADOR SLOWDNS"
    msg -bar
    echo -e " $(msg -ama "Puerto de conexión atraves de SlowDNS:") $(msg -verd "$PORT")"
    msg -bar
    ...
    if [[ ! -e ${SlowDNSinstall}/dns-server ]]; then
      ...
      if wget -O ${SlowDNSinstall}/dns-server https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/Ejecutables/dns-server &>/dev/null; then
  ...
  echo -ne " \e[1;93m [\e[1;32m3\e[1;93m]\033[1;31m > \033[1;97m INFORMACIÓN \e[97m \n"
...
sshl_install() {
  ...
  sslh_inicial() {
    ...
    msg -tit
    msg -bar
    echo -e "\033[1;93m           INSTALADOR SSLH SCRIPT ELEMENT"
    msg -bar
  ...
  msg -tit
  msg -bar
  echo -e "\e[1;93m          INSTALADOR DE SSLH | SCRIPT ELEMENT"
  msg -bar
...
control_v2ray() {
  ...
  intallv2ray() {
    ...
    msg -bar
    source <(curl -sL https://raw.githubusercontent.com/NearVPN/ELEMENT_Oficial/main/Ejecutables/v2ray.sh)
    v2ray update
    ...
    USRdatabase="/etc/SCRIPT-ELEMENT/RegV2ray"
  ...
  unistallv2() {
    ...
    rm -rf /etc/SCRIPT-ELEMENT/RegV2ray >/dev/null 2>&1
    rm -rf /etc/SCRIPT-ELEMENT/v2ray/* >/dev/null 2>&1
  ...
  addusr() {
    ...
    ##Registro
    echo "  $UUID | $nick | $valid " >>/etc/SCRIPT-ELEMENT/RegV2ray
    Fecha=$(date +%d-%m-%y-%R)
    cp /etc/SCRIPT-ELEMENT/RegV2ray /etc/SCRIPT-ELEMENT/v2ray/RegV2ray-"$Fecha"
    cp /etc/SCRIPT-ELEMENT/RegV2ray /etc/v2ray/config.json-"$Fecha"
    v2ray restart >/dev/null 2>&1
    echo ""
    v2ray info >/etc/SCRIPT-ELEMENT/v2ray/confuuid.log
    lineP=$(sed -n '/'${UUID}'/=' /etc/SCRIPT-ELEMENT/v2ray/confuuid.log)
    numl1=4
    let suma=$lineP+$numl1
    sed -n ${suma}p /etc/SCRIPT-ELEMENT/v2ray/confuuid.log
    echo ""
    msg -bar
  ...
  delusr() {
    ...
    echo -e "\e[1;33m$(cat /etc/SCRIPT-ELEMENT/RegV2ray | cut -d '|' -f2,1)"
    msg -bar
    echo -ne "\e[91m >> Digita el usuario a eliminar:\n \033[1;92m " && read userv
    uuidel=$(cat /etc/SCRIPT-ELEMENT/RegV2ray | grep -w "$userv" | cut -d'|' -f1 | tr -d " \t\n\r")
    [[ $(sed -n '/'${uuidel}'/=' /etc/v2ray/config.json | head -1) ]] || invaliduuid
    lineP=$(sed -n '/'${uuidel}'/=' /etc/v2ray/config.json)
    linePre=$(sed -n '/'${uuidel}'/=' /etc/SCRIPT-ELEMENT/RegV2ray)
    sed -i "${linePre}d" /etc/SCRIPT-ELEMENT/RegV2ray
    numl1=2
  ...
  mosusr_kk() {
    ...
    msg -bar
    # usersss=$(cat /etc/SCRIPT-ELEMENT/RegV2ray|cut -d '|' -f1)
    # cat /etc/SCRIPT-ELEMENT/RegV2ray|cut -d'|' -f3
    VPSsec=$(date +%s)
    local HOST="/etc/SCRIPT-ELEMENT/RegV2ray"
    local HOST2="/etc/SCRIPT-ELEMENT/RegV2ray"
    ...
    if [[ -z $RETURN ]]; then
      ...
      while read hostreturn; do
        DateExp="$(cat /etc/SCRIPT-ELEMENT/RegV2ray | grep -w "$hostreturn" | cut -d'|' -f3)"
        if [[ ! -z $DateExp ]]; then
        ...
        usris="$(cat /etc/SCRIPT-ELEMENT/RegV2ray | grep -w "$hostreturn" | cut -d'|' -f2)"
      ...
      [[ ! -z $contador_secuencial ]] && {
        linesss=$(cat /etc/SCRIPT-ELEMENT/RegV2ray | wc -l)
  ...
  limpiador_activador() {
    ...
    if [[ ! $PIDGEN ]]; then
      screen -dmS limv2ray watch -n 21600 /etc/SCRIPT-ELEMENT/menu.sh "exlimv2ray"
    else
      #killall screen
  ...
  backup_fun() {
    ...
    1)
      ...
      cp /etc/SCRIPT-ELEMENT/RegV2ray $HOME/RegV2ray
    ...
    2)
      ...
      cp /root/RegV2ray /etc/SCRIPT-ELEMENT/RegV2ray
      echo -e "\033[1;31mRESTAURADO > [\033[1;32m/etc/v2ray/config.json \033[1;31m]"
      echo -e "\033[1;31mRESTAURADO > [\033[1;32m/etc/SCRIPT-ELEMENT/RegV2ray \033[1;31m]"
      ;;
    3)
...
controlador_ssh() {
  ...
  eliminar_all() {
    ...
    rm -rf /etc/SCRIPT-ELEMENT/cuentassh &>/dev/null
    rm -rf /etc/SCRIPT-ELEMENT/cuentahwid &>/dev/null
    rm -rf /etc/SCRIPT-ELEMENT/cuentatoken &>/dev/null
    service sshd restart &>/dev/null
    service ssh restart &>/dev/null
    service dropbear start &>/dev/null
    service stunnel4 start &>/dev/null
    service squid restart &>/dev/null
    rm -rf /etc/SCRIPT-ELEMENT/temp/userlock &>/dev/null
    rm -rf /etc/SCRIPT-ELEMENT/temp/Limiter.log &>/dev/null
    unlockall2
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    controlador_ssh
  ...
  reset_contador() {
    ...
    msg -bar
    read -p "        ►► Presione enter para continuar ◄◄"
    rm -rf /etc/SCRIPT-ELEMENT/temp/userlock
    rm -rf /etc/SCRIPT-ELEMENT/temp/Limiter.log
    unlockall2
    msg -bar
  ...
  block_userfun() {
    local USRloked="/etc/SCRIPT-ELEMENT/temp/userlock"
    local LIMITERLOG="/etc/SCRIPT-ELEMENT/temp/Limiter.log"
    local LIMITERLOG2="/etc/SCRIPT-ELEMENT/temp/Limiter2.log"
    if [[ $2 = "-loked" ]]; then
  ...
  block_user() {
    ...
    if [[ -z ${usuarios_totales[@]} ]]; then
      ...
      for us in $(echo ${usuarios_ativos2[@]}); do
        if [[ $(cat ${USRloked} | grep -w "${us}") ]]; then
          nomhwid="$(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "${us}" | cut -d'|' -f5)"
      ...
      for us in $(echo ${usuarios_ativos3[@]}); do
        if [[ $(cat ${USRloked} | grep -w "${us}") ]]; then
          nomtoken="$(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "${us}" | cut -d'|' -f5)"
  ...
  add_user() {
    ...
    echo "$1|$2|${datexp}|$4" >>/etc/SCRIPT-ELEMENT/cuentassh
    echo "$1|$2|${datexp}|$4" >>/etc/SCRIPT-ELEMENT/regtotal
    echo "" >/dev/null 2>&1
  }
  ...
  renew_user_fun() {
    ...
    sed -i '/'$1'/d' /etc/SCRIPT-ELEMENT/temp/userexp 2>/dev/null
    #---  LECTOR DE CUENTAS
    mostrar_usuariossh() {
      for u in $(cat /etc/SCRIPT-ELEMENT/cuentassh | cut -d'|' -f1); do
        echo "$u"
    ...
    if [[ -z ${usuarios_ativos1[@]} ]]; then
      ...
      [[ $(grep -o -i $1 /etc/SCRIPT-ELEMENT/cuentassh) ]] && {
        pass=$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "$1" | cut -d'|' -f2)
        limit=$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "$1" | cut -d'|' -f4)
        userb=$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -n -w $1 | cut -d'|' -f1 | cut -d':' -f1)
        sed -i "${userb}d" /etc/SCRIPT-ELEMENT/cuentassh
        echo "$1|$pass|${datexp}|$limit|$userb" >>/etc/SCRIPT-ELEMENT/cuentassh
      }
    fi
    #HWID
    if [[ -z ${usuarios_ativos2[@]} ]]; then
      ...
      [[ $(grep -o -i $1 /etc/SCRIPT-ELEMENT/cuentahwid) ]] && {
        nomhwid="$(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "$1" | cut -d'|' -f5)"
        sed -i '/'$1'/d' /etc/SCRIPT-ELEMENT/cuentahwid
        echo "$1||${datexp}||$nomhwid" >>/etc/SCRIPT-ELEMENT/cuentahwid
      }
    fi
    #TOKEN
    if [[ -z ${usuarios_ativos3[@]} ]]; then
      ...
      [[ $(grep -o -i $1 /etc/SCRIPT-ELEMENT/cuentatoken) ]] && {
        nomtoken="$(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "$1" | cut -d'|' -f5)"
        sed -i '/'$1'/d' /etc/SCRIPT-ELEMENT/cuentatoken
        echo "$1||${datexp}||$nomtoken" >>/etc/SCRIPT-ELEMENT/cuentatoken
      }
    fi
    echo "" >/dev/null 2>&1
  }
  ...
  new_user() {
    ...
    if [[ -z ${usuarios_ativos[@]} ]]; then
      ...
      mostrar_usuariosshf2() {
        for u in $(cat /etc/SCRIPT-ELEMENT/cuentassh | cut -d'|' -f2); do
          echo "$u"
        done
      }
      mostrar_usuariohwid() {
      ...
      [[ -e "/etc/SCRIPT-ELEMENT/cuentassh" ]] && usuarios_ativos1=($(mostrar_usuariossh))
      [[ -e "/etc/SCRIPT-ELEMENT/cuentassh" ]] && usuarios_ativosf2=($(mostrar_usuariosshf2))
      [[ -e "/etc/SCRIPT-ELEMENT/cuentahwid" ]] && usuarios_ativos2=($(mostrar_usuariohwid))
      [[ -e "/etc/SCRIPT-ELEMENT/cuentatoken" ]] && usuarios_ativos3=($(mostrar_usuariotoken))
    ...
    cuenta_hwid() {
      ...
      echo "$nomeuser||${datexp}||${nickhwid}" >>/etc/SCRIPT-ELEMENT/cuentahwid
      echo "$nomeuser||${datexp}||${nickhwid}" >>/etc/SCRIPT-ELEMENT/regtotal
    ...
    cuenta_token() {
      ...
      [[ -e "/etc/SCRIPT-ELEMENT/temp/.passw" ]] || passgeneral
      while true; do
      ...
      echo -ne "\e[38;5;202mFecha de Expiracion: \e[1;97m" && echo -e "$(date "+%F" -d " + $diasuser days")"
      msg -bar
      passtoken=$(cat /etc/SCRIPT-ELEMENT/temp/.passw | tr -d " \t\n\r")
      ...
      echo "$nomeuser||${datexp}||${nickhwid}" >>/etc/SCRIPT-ELEMENT/cuentatoken
      echo "$nomeuser||${datexp}||${nickhwid}" >>/etc/SCRIPT-ELEMENT/regtotal
      msg -ama "\e[1;32m            Usuario Creado con Exito" || msg -verm "         Error, Usuario no creado"
      rebootnb "backbaseu" 2>/dev/null
  ...
  remove_user() {
    ...
    if [[ -z ${usuarios_ativos1[@]} ]]; then
      ...
      [[ $(grep -o -i $usuario_del /etc/SCRIPT-ELEMENT/cuentassh) ]] && {
        userb=$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -n -w $usuario_del | cut -d'|' -f1 | cut -d':' -f1)
    ...
    if [[ -z ${usuarios_ativos2[@]} ]]; then
      ...
      [[ $(grep -o -i $usuario_del /etc/SCRIPT-ELEMENT/cuentahwid) ]] && {
        sed -i '/'$usuario_del'/d' /etc/SCRIPT-ELEMENT/cuentahwid >/dev/null 2>&1
      }
    fi
    #TOKEN
    if [[ -z ${usuarios_ativos3[@]} ]]; then
      ...
      [[ $(grep -o -i $usuario_del /etc/SCRIPT-ELEMENT/cuentatoken) ]] && {
        sed -i '/'$usuario_del'/d' /etc/SCRIPT-ELEMENT/cuentatoken >/dev/null 2>&1
      }
    fi
  ...
  renew_user() {
    ...
    if [[ -z ${usuarios_totales[@]} ]]; then
      ...
      for us in $(echo ${usuarios_ativos1[@]}); do
        VPSsec=$(date +%s)
        DateExp="$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "${us}" | cut -d'|' -f3)"
        DataSec=$(date +%s --date="$DateExp")
      ...
      for us in $(echo ${usuarios_ativos2[@]}); do
        VPSsec=$(date +%s)
        DateExp="$(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "${us}" | cut -d'|' -f3)"
        DataSec=$(date +%s --date="$DateExp")
        if [[ "$VPSsec" -gt "$DataSec" ]]; then
          EXPTIME="${red}[Exp]"
        else
      ...
      for us in $(echo ${usuarios_ativos3[@]}); do
        VPSsec=$(date +%s)
        DateExp="$(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "${us}" | cut -d'|' -f3)"
        DataSec=$(date +%s --date="$DateExp")
        if [[ "$VPSsec" -gt "$DataSec" ]]; then
          EXPTIME="${red}[Exp]"
        else
  ...
  edit_user() {
    ...
    edit_user_fun "${useredit}" "${senhauser}" "${diasuser}" "${limiteuser}" && echo -e "\e[1;32m      Usuario Modificado Con Exito" && rm -rf /etc/SCRIPT-ELEMENT/temp/Limiter.log || msg -verm "Error, Usuario nao Modificado"
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    controlador_ssh
  }
  ...
  detail_user() {
    ...
    if [[ -z ${usuarios_totales[@]} ]]; then
      ...
      [[ -e "/etc/SCRIPT-ELEMENT/cuentassh" ]] && usuarios_ativos1=($(mostrar_usuariosssh))
      if [[ -z ${usuarios_ativos1[@]} ]]; then
        echo "" >/dev/null 2>&1
      else
        echo -e "\033[38;5;239m════════════════\e[100m\e[97m  CUENTAS NORMALES  \e[0m\e[38;5;239m════════════════"
        while read user; do
          ...
          if [[ -e "/etc/SCRIPT-ELEMENT/cuentassh" ]]; then
            if [[ $(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "${user}") ]]; then
              txtvar+="$(printf '%-27s' "${yellow}$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "${user}" | cut -d'|' -f2)")"
              DateExp="$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "${user}" | cut -d'|' -f3)"
              DataSec=$(date +%s --date="$DateExp")
              if [[ "$VPSsec" -gt "$DataSec" ]]; then
                EXPTIME="${red}[Exp]"
              else
              ...
              txtvar+="$(printf '%-1s' "\e[1;36m$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "${user}" | cut -d'|' -f4)")"
            else
      ...
      [[ -e "/etc/SCRIPT-ELEMENT/cuentahwid" ]] && usuarios_ativos2=($(mostrar_usuarioshwid))
      if [[ -z ${usuarios_ativos2[@]} ]]; then
        echo "" >/dev/null 2>&1
      else
        echo -e "\033[38;5;239m════════════════\e[100m\e[97m  CUENTAS CON HWID  \e[0m\e[38;5;239m════════════════"
        while read user; do
          ...
          nomhwid="$(printf '%-18s' "\e[1;36m$(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "${user}" | cut -d'|' -f5)")"
          if [[ -e "/etc/SCRIPT-ELEMENT/cuentahwid" ]]; then
            if [[ $(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "${user}") ]]; then
              #txtvar+="$(printf '%-18s' "${yellow}$(cat ${USRdatabase} | grep -w "${user}" | cut -d'|' -f2)")"
              DateExp="$(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "${user}" | cut -d'|' -f3)"
              DataSec=$(date +%s --date="$DateExp")
              if [[ "$VPSsec" -gt "$DataSec" ]]; then
                EXPTIME="${red}[Exp]"
              else
              ...
              txtvar+="$(printf '%-25s' "${red}${DateExp}${EXPTIME}")"
              txtvar+="$(printf '%-1s' "\e[1;36m$(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "${user}" | cut -d'|' -f4)")"
            else
              txtvar+="$(printf '%-21s' "${red}")"
              txtvar+="$(printf '%-29s' "${red}")"
              txtvar+="$(printf '%-5s' "${red}")"
      ...
      if [[ -z ${usuarios_ativos3[@]} ]]; then
        ...
        while read user; do
          ...
          if [[ -e "/etc/SCRIPT-ELEMENT/cuentatoken" ]]; then
            if [[ $(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "${user}") ]]; then
              #txtvar+="$(printf '%-18s' "${yellow}$(cat ${USRdatabase} | grep -w "${user}" | cut -d'|' -f2)")"
              txtvar+="$(printf '%-18s' "\e[1;36m$(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "${user}" | cut -d'|' -f5)")"
              DateExp="$(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "${user}" | cut -d'|' -f3)"
              DataSec=$(date +%s --date="$DateExp")
              if [[ "$VPSsec" -gt "$DataSec" ]]; then
                EXPTIME="${red}[Exp]"
              else
              ...
              txtvar+="$(printf '%-25s' "${red}${DateExp}${EXPTIME}")"
              txtvar+="$(printf '%-1s' "\e[1;36m$(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "${user}" | cut -d'|' -f4)")"
            else
              txtvar+="$(printf '%-21s' "${red}")"
              txtvar+="$(printf '%-29s' "${red}")"
              txtvar+="$(printf '%-5s' "${red}")"
  ...
  monit_user() {
      ...
      if [[ -z ${usuarios_ativos1[@]} ]]; then
        ...
        while read user; do
          _=$(
            ...
            [[ -z $(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "${user}") ]] && MAXUSER="?" || MAXUSER="$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "${user}" | cut -d'|' -f4)"
      ...
      if [[ -z ${usuarios_ativos2[@]} ]]; then
        ...
        while read user; do
          _=$(
            ...
            [[ $(dpkg --get-selections | grep -w "openvpn" | head -1) ]] && [[ -e /etc/openvpn/openvpn-status.log ]] && [[ $(openvpn_pids | grep -w "$user" | cut -d'|' -f2) ]] && PID+="$(openvpn_pids | grep -w "$user" | cut -d'|' -f2)+"
            PID+="0"
            nomhwid="\e[1;96m$(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "${user}" | cut -d'|' -f5)"
            [[ -z $(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "${user}") ]] && MAXUSER="?" || MAXUSER="$(cat /etc/SCRIPT-ELEMENT/cuentahwid | grep -w "${user}" | cut -d'|' -f4)"
            [[ $(echo $PID | bc) -gt 0 ]] && user="$user \e[1;93m[\033[1;32m ON \e[1;93m]" || user="$user \e[1;93m[\033[1;31m OFF \e[1;93m]"
      ...
      if [[ -z ${usuarios_ativos3[@]} ]]; then
        ...
        while read user; do
          _=$(
            ...
            [[ $(dpkg --get-selections | grep -w "openvpn" | head -1) ]] && [[ -e /etc/openvpn/openvpn-status.log ]] && [[ $(openvpn_pids | grep -w "$user" | cut -d'|' -f2) ]] && PID+="$(openvpn_pids | grep -w "$user" | cut -d'|' -f2)+"
            PID+="0"
            nomtoken="$(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "${user}" | cut -d'|' -f5)"
            [[ -z $(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "${user}") ]] && MAXUSER="?" || MAXUSER="$(cat /etc/SCRIPT-ELEMENT/cuentatoken | grep -w "${user}" | cut -d'|' -f4)"
    ...
    onlinest=$(cat /etc/SCRIPT-ELEMENT/temp/Tonli)
    msg -bar
  ...
  rm_vencidos() {
    ...
    if [[ -z ${usuarios_ativos1[@]} ]]; then
      ...
      while read user; do
        ...
        if [[ "$DataSEC" -lt "$DataVPS" ]]; then
          ...
          userb=$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -n -w $user | cut -d'|' -f1 | cut -d':' -f1)
          sed -i "${userb}d" /etc/SCRIPT-ELEMENT/cuentassh
        else
    ...
    if [[ -z ${usuarios_ativos2[@]} ]]; then
      ...
      while read user; do
        ...
        if [[ "$DataSEC" -lt "$DataVPS" ]]; then
          ...
          # kill -9 $droplim &>/dev/null
          rm_user "$user" && echo -e " y ($removido)"
          sed -i '/'$user'/d' /etc/SCRIPT-ELEMENT/cuentahwid
        else
          echo -e "\e[1;97m$usr $valid"
        fi
      done <<<"$(mostrar_usuarioshwid)"
    ...
    if [[ -z ${usuarios_ativos3[@]} ]]; then
      ...
      while read user; do
        ...
        if [[ "$DataSEC" -lt "$DataVPS" ]]; then
          ...
          # kill -9 $droplim &>/dev/null
          rm_user "$user" && echo -e "y ($removido)"
          sed -i '/'$user'/d' /etc/SCRIPT-ELEMENT/cuentatoken
        else
          echo -e "\e[1;97m$usr $valid"
        fi
      done <<<"$(mostrar_usuariotoken)"
    ...
    rm -rf /etc/SCRIPT-ELEMENT/temp/userlock
    rm -rf /etc/SCRIPT-ELEMENT/temp/userexp
    unlockall2
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    controlador_ssh
  ...
  backup_fun() {
    ...
    restaurarback() {
      ...
      cat cuentassh >/etc/SCRIPT-ELEMENT/cuentassh
      cat cuentahwid >/etc/SCRIPT-ELEMENT/cuentahwid
      cat cuentatoken >/etc/SCRIPT-ELEMENT/cuentatoken
      cat .passw >/etc/SCRIPT-ELEMENT/temp/.passw
      cd /
  ...
  verif_funx() {
    ...
    PIDVRF="$(ps aux | grep "/etc/SCRIPT-ELEMENT/menu.sh verificar" | grep -v grep | awk '{print $2}')"
    if [[ -z $PIDVRF ]]; then
      msg -bar
      ...
      error() {
        ...
        tput dl1
        tiemlim="120"
        echo "${tiemlim}" >/etc/SCRIPT-ELEMENT/temp/T-Lim
      ...
      [[ -e /etc/SCRIPT-ELEMENT/temp/USRonlines ]] && rm /etc/SCRIPT-ELEMENT/temp/USRonlines
      [[ -e /etc/SCRIPT-ELEMENT/temp/USRexpired ]] && rm /etc/SCRIPT-ELEMENT/temp/USRexpired
      [[ -e /etc/SCRIPT-ELEMENT/temp/USRbloqueados ]] && rm /etc/SCRIPT-ELEMENT/temp/USRbloqueados
    fi
    msg -bar
  ...
  verif2_funx() {
    ...
    PIDVRF2="$(ps aux | grep "/etc/SCRIPT-ELEMENT/menu.sh desbloqueo" | grep -v grep | awk '{print $2}')"
    if [[ -z $PIDVRF2 ]]; then
      msg -bar
      ...
      error() {
        ...
        tput dl1
        tiemdes="120"
        echo "${tiemdes}" >/etc/SCRIPT-ELEMENT/temp/T-Des
      }
      ...
      #screen -dmS very2 /etc/SCRIPT-ELEMENT/menu.sh desbloqueo
    else
  ...
  baner_fun() {
    banner_on() {
      clear && clear
      local="/etc/SCRIPT-ELEMENT/bannerssh"
      ...
      if [ "$(echo "$chk" | grep -v "#Banner" | grep Banner)" != "" ]; then
        ...
        echo "Banner /etc/SCRIPT-ELEMENT/bannerssh" >>/etc/ssh/sshd_config
        local="/etc/SCRIPT-ELEMENT/bannerssh"
      fi
      msg -bar
      msg -tit
      ...
      echo ""
      msg -bar
      credi="$(less /etc/SCRIPT-ELEMENT/message.txt)"
      echo "$ban_ner" >>$local
      echo '<p style="text-align: center;"><strong><span style="color: #993300;">'$credi'</span></strong></p>' >>$local
      echo '<p style="text-align: center;"><strong>SCRIPT <span style="color: #ff0000;">|</span><span style="color: #ffcc00;"> ELEMENT</span></strong></p>' >>$local
      if [[ -e "$local2" ]]; then
  ...
  rec_total() {
    ...
    msg -bar
    cat /etc/SCRIPT-ELEMENT/regtotal
    msg -bar
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    controlador_ssh
  }
  ...
  demo_ssh() {
    ...
    rm -rf /etc/SCRIPT-ELEMENT/temp/demo-ssh 2>/dev/null
    mkdir /etc/SCRIPT-ELEMENT/temp/demo-ssh 2>/dev/null
    SCPdir="/etc/SCRIPT-ELEMENT"
    declare -A cor=([0]="\033[1;37m" [1]="\033[1;34m" [2]="\033[1;31m" [3]="\033[1;33m" [4]="\033[1;32m")
    tmpusr() {
      time="$1"
...
exit" >/tmp/$2
    ...
    rm -rf /tmp/cmd
    touch /etc/SCRIPT-ELEMENT/temp/demo-ssh/$name
    echo "senha: $pass" >>/etc/SCRIPT-ELEMENT/temp/demo-ssh/$name
    echo "data: ($tmp)Minutos" >>/etc/SCRIPT-ELEMENT/temp/demo-ssh/$name
    msg -bar2
  ...
  [[ -e "/etc/SCRIPT-ELEMENT/temp/Limiter2.log" ]] && echo -e "\e[1;93m [\e[1;32m18\e[1;93m]\033[1;31m > \e[1;97mVER LOG DE LIMITADOR "
  msg -bar
  echo -e "    \e[97m\033[1;41m ENTER SIN RESPUESTA REGRESA A MENU ANTERIOR \033[0;37m"
  msg -bar
  ...
  16) rec_total ;;
  17)
    rm -rf /etc/SCRIPT-ELEMENT/temp/Limiter2.log
  ...
  18)
    clear && clear
    msg -bar
    sed -i -e 's/^[ \t]*//; s/[ \t]*$//; /^$/d' /etc/SCRIPT-ELEMENT/temp/Limiter2.log
    [[ -e "/etc/SCRIPT-ELEMENT/temp/Limiter2.log" ]] && {
      msg -tit
      msg -bar
      msg -ama "              REGISTRO DEL LIMITADOR "
      msg -bar
      cat /etc/SCRIPT-ELEMENT/temp/Limiter2.log
      msg -bar
    }
    read -t 60 -n 1 -rsp $'\033[1;39m       << Presiona enter para Continuar >>\n'
    controlador_ssh
...
verif_fun() {
  ...
  [[ -e "/etc/SCRIPT-ELEMENT/cuentasactivast" ]] && usuarios_totales=($(mostrar_totales))
  if [[ -z ${usuarios_totales[@]} ]]; then
    echo "" >/dev/null 2>&1
  else
    ...
    while read user; do
      ...
      if [[ "$DataSEC" -lt "$TimeNOW" ]]; then
        ...
        [[ $(cat ${USRloked} | grep -w "$user") ]] || {
          ...
          echo "$user" >>/etc/SCRIPT-ELEMENT/temp/userexp
      ...
      echo "${ONLINES}0" | bc >/etc/SCRIPT-ELEMENT/temp/USRonlines

      #----CONTADOR DE LIMITE X USER
      local conexao[$user]="$(echo ${PID}0 | bc)"
      local limite[$user]="$(cat /etc/SCRIPT-ELEMENT/cuentassh | grep -w "${user}" | cut -d'|' -f4)"
      ...
      echo "${EXPIRED}0" | bc >/etc/SCRIPT-ELEMENT/temp/USRexpired
    done <<<"$(mostrar_totales)"
  fi
  sed -i '/'-loked'/d' /etc/SCRIPT-ELEMENT/temp/userlock
  BLOQUEADO="$(wc -l /etc/SCRIPT-ELEMENT/temp/userlock | awk '{print $1}')"
  BLOQUEADO2="$(echo ${BLOQUEADO} | bc)0"
  BLOQUEADO3="/10"
  echo "${BLOQUEADO2}${BLOQUEADO3}" | bc >/etc/SCRIPT-ELEMENT/temp/USRbloqueados
  sed -i -e 's/^[ \t]*//; s/[ \t]*$//; /^$/d' /etc/SCRIPT-ELEMENT/temp/userexp
  EXPIRADO="$(wc -l /etc/SCRIPT-ELEMENT/temp/userexp | awk '{print $1}')"
  EXPIRADO2="$(echo ${EXPIRADO} | bc)0"
  EXPIRADO3="/10"
  echo "${EXPIRADO2}${EXPIRADO3}" | bc >/etc/SCRIPT-ELEMENT/temp/USRexpired
    ...
    if [[ -z $RETURN ]]; then
      ...
      while read hostreturn; do
        delbug() {
          ...
          linePre=$(sed -n '/'${hostreturn}'/=' /etc/SCRIPT-ELEMENT/RegV2ray)
          sed -i "${linePre}d" /etc/SCRIPT-ELEMENT/RegV2ray
          numl1=2
          let resta=$lineP-$numl1
          sed -i "${resta}d" /etc/v2ray/config.json
...
actulizar_fun() {
  ...
  msg -tit
  msg -bar
  echo -e "\a\a\a\a\e[1;93m          >>> ACTULIZAR SCRIPT-ELEMENT <<< "
  msg -bar
